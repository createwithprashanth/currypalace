      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-brand-cream/35 text-[10px] tracking-[0.25em] uppercase mb-3">Restaurant · Abu Dhabi</p>
            <p
            ...
            <p className="text-brand-gold/50 text-xs tracking-wide">🌴 Kerala · UAE</p>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-brand-cream/55 text-xs leading-relaxed">
                  Al Zahiyah, Tourist Club Area<br />Electra Road, Behind KFC<br />Abu Dhabi, UAE
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={13} className="text-brand-gold/60 shrink-0" />
                <a href="tel:024484041" className="text-brand-cream/55 hover:text-brand-gold text-xs transition-colors">02 448 4041</a>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="https://wa.me/971551899500" target="_blank" rel="noopener noreferrer" className="text-brand-cream/55 hover:text-[#25d366] text-xs transition-colors">055 189 9500</a>
              </li>
              <li className="flex items-center gap-3">
                <Clock size={13} className="text-brand-gold/60 shrink-0" />
                <span className="text-brand-cream/55 text-xs">Open 24 Hours · Every Day</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            >
              <Instagram size={14} /> @curry_palace
            </a>
            <div className="space-y-2">
              <a
                href="https://wa.me/971551899500?text=Hello%20Curry%20Palace!%20I%20would%20like%20to%20order."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-brand-cream/25 text-xs text-center sm:text-left">
          <p>© {new Date().getFullYear()} Curry Palace Restaurant · Al Zahiyah, Abu Dhabi, UAE</p>
          <p className="text-brand-cream/20">VAT Included · Free Home Delivery · Open 24/7 · 🌴 Kerala Flavours</p>
        </div>
      </div>
    </footer>
  );
