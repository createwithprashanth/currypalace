  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="relative w-14 h-14 bg-[#25d366] hover:bg-[#22c55e] rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.5)] hover:shadow-[0_4px_28px_rgba(37,211,102,0.7)] hover:scale-110 transition-all duration-300 pulse-ring"
      >
