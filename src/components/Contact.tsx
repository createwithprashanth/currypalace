    ...
    <section id="contact" className="py-24 bg-brand-dark relative overflow-hidden">
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-14 transition-all duration-700 ${vis ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <p className="text-brand-gold text-xs font-semibold tracking-[0.3em] uppercase mb-3">Get In Touch</p>
          <h2
          ...
          <p className="mt-5 text-brand-cream/55 max-w-xl mx-auto text-sm">
            Reserve a table, place an order, or simply say hello. We&apos;re always here for you.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className={`transition-all duration-700 delay-200 ${vis ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}>
            <h3 className="text-brand-gold font-semibold text-sm tracking-wide uppercase mb-5">Send a Message</h3>
            <div className="glass-card rounded-2xl p-6 space-y-4">
              <div>
                <label className="text-brand-cream/60 text-xs font-medium block mb-2">Your Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-brand-cream/60 text-xs font-medium block mb-2">Phone Number</label>
                <input
                  type="tel"
                  placeholder="+971 ..."
                  value={form.phone}
              ...
              <div>
                <label className="text-brand-cream/60 text-xs font-medium block mb-2">Message / Order</label>
                <textarea
                  rows={4}
                  placeholder="e.g. I'd like to order 2x Biriyani, 1x Kothu Porotta..."
                  value={form.message}
